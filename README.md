...
1. Download [Prebuilt Binary](https://github.com/samsarahq/oauth2_proxy/releases) (current release is `v2.3`) or build with `$ go get github.com/samsarahq/oauth2_proxy` which will put the binary in `$GOROOT/bin`
